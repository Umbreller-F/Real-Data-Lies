...
def select_and_copy_videos():
    ...
    # Configuration
    source_dir = "/data1/Data_AIGVDetect/extra_videos/RealVSR/videos"
    target_dir = "../Data/VQA_videos/RealVSR"
    ...
    # Get all MOV files
    all_files = [f for f in os.listdir(source_dir) if f.endswith('.mov')]

...
bars = plt.barh(y_pos, df2_sorted['NIQE_Mean'], 
                xerr=df2_sorted['NIQE_Std'], 
                capsize=3, alpha=0.7,
                color=colors,
...
x_max = max(df2_sorted['NIQE_Mean']) + df2_sorted['NIQE_Std'].max() + 0.3

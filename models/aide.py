...
def AIDE(resnet_path='ckpts/resnet50-19c8e357.pth', convnext_path='ckpts/open_clip_pytorch_model.bin'):
...
if __name__ == "__main__":
    ...
    model = AIDE(resnet_path='ckpts/resnet50-19c8e357.pth', convnext_path='ckpts/open_clip_pytorch_model.bin')
